...
--
-- adjust the ESS Setpoint when charging/discharging when the phase power is too high
...
return {
	...
	on = {
		timer = { 'every minute' },
		devices = { 'Battery Mode', 'Battery SOC', 'Grid L1 Watt', 'Grid L2 Watt', 'Grid L3 Watt' },
	},
	data = {
	    adjusted = { initial = 0 },
